...
/** \brief Se muestra un mensaaje y pide al usuario ue ingrese un nombre por consola
 *   Luego se llama a la funcion que validara si el dato esta dentro del rango
 *
 * \param resultado: Puntero a variable donde se escribirá el valor ingresado en el caso de ser correcto.
 * \param msg: Puntero a cadena de caracteres con mensaje a imprimir antes de pedirle al usuario datos por consola.
...
/** \brief Se muestra un mensaaje y pide al usuario ue ingrese un apellido por consola
 *   Luego se llama a la funcion que validara si el dato esta dentro del rango
 *
 * \param resultado: Puntero a variable donde se escribirá el valor ingresado en el caso de ser correcto.
 * \param msg: Puntero a cadena de caracteres con mensaje a imprimir antes de pedirle al usuario datos por consola.
...
/** \brief Muestra un mensaje y pide al usuario un ENTREO POSITIVO. Luego llama a la funcion que valida el rango
 *
 * \param resultado: Puntero a variable donde se escribirá el valor ingresado en el caso de ser correcto.
 * \param msg: Puntero a cadena de caracteres con mensaje a imprimir antes de pedirle al usuario un numero por consola.
 * \param msgError: Puntero a cadena de caracteres con mensaje de error en el caso de que el dato ingresado no sea válido.
...
/** \brief Muestra un mensaje y pide al usuario un ENTREO que puede ser negativo. Luego llama a la funcion que valida el rango
 *
 * \param resultado: Puntero a variable donde se escribirá el valor ingresado en el caso de ser correcto.
 * \param msg: Puntero a cadena de caracteres con mensaje a imprimir antes de pedirle al usuario un numero por consola.
 * \param msgError: Puntero a cadena de caracteres con mensaje de error en el caso de que el dato ingresado no sea válido.
...
/** \brief recibe una cadena y valida que este compuesta por numeros o signo negativo
 *
 * \param cadena: recibe
 * \param
 * \return true si la cadena es de numeros y tiene o no signo negativo o false si no esta compuesta por numero
 *
 */
...
int utn_isValidDigitoVerificador (char* cadena )
{
    ...
    int retorno = TRUE;
    int i;
    int mult [] = {5,4,3,2,7,6,5,4,3,2};//= "5432765432";//{'5', '4', '3', '2', '7', '6', '5', '4', '3', '2', '\0'} ;//revisar


    int total = 0;
    int digitCheck;

    for( i=0 ;  i < 10 mult[i] != '\0'  ; i++)
    {
        total += mult[i] * cadena[i];
        printf(" pos i %d valor mult: %d valor cadena: %s  total: %d\n", i, mult, cadena, total);
    }
    printf(" pos i %d \n", total);
    digitCheck = LONG_CUIT - (total % LONG_CUIT);
    printf("digito %d \n",digitCheck);
    if(digitCheck != cadena[11])////revisar
    {
        retorno = FALSE;
    }
